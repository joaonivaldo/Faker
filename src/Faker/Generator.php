 ...
 *
 * @method string imageUrl($width = 640, $height = 480, $category = 'any', $filter=null)
 * @method string image($dir = null, $width = 640, $height = 480, $category = 'any', $fullPath = true, $filter=null)
 *
